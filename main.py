...
def merge_full(layout_name, video01_filename, video02_filename, video03_filename, video04_filename,
    ...
    if layout_name == '2_05':
        ...
        clip1 = VideoFileClip(video01_filename, fps_source='fps')
        clip2 = VideoFileClip(video02_filename, fps_source='fps')
        #print('clip1-01 length: ' + str(clip1.duration) + " seconds")

        total_duration01 = (clip1.duration * 1000) + delay01  # millisecond
        total_duration02 = (clip2.duration * 1000) + delay02  # millisecond

        clip_duration = max(total_duration01, total_duration02) / 1000.0
        ...
        black_video02 = ColorClip(size=(950, 530), color=(0, 0, 0), duration=clip_duration)
        ...
        wav01_clip3 = wav01_clip2.with_effects([mp.video.fx.Resize((955, 360))])
        ...
        black_video_wave01 = ColorClip(size=(955, 360), color=(0, 0, 0), duration=clip_duration)
        ...
        black_video_wave02 = ColorClip(size=(955, 360), color=(0, 0, 0), duration=clip_duration)
        ...
        final_clip = CompositeVideoClip([
                                         ...
                                         wav01_clip4.with_position((960, 0)),
    ...
    if layout_name == '2_06':
        ...
        clip_duration = max((total_duration01 / 1000.0) / (total_duration02 / 1000.0))
        ...
        black_video01 = ColorClip(size=(603, 1070), color=(0, 0, 0), duration=clip_duration)
        ...
        #new_clip1 = mp.video.fx.Margin(5, color=(255, 255, 0)).add_margin(new_clip1)
        black_video02 = ColorClip(size=(1302, 733), color=(0, 0, 0), duration=clip_duration)
        ...
        #if delay02 > 0:
        #    black_video02 = ColorClip(size=(1302, 733), color=(0, 0, 0), duration=total_duration02)
        #    #black_video02 = black_video.subclipped('00:00:00.000', milli_to_timecode(delay02))
        ...
        final_clip = CompositeVideoClip([new_clip1.with_position((0,0)), new_clip2.with_position((613, 0)), wav_clip4.with_position((613,743))],
                                        size=(1920, 1080))
        # use wav duration
        #final_clip = final_clip.subclipped(0, wav_clip4.duration)
    ...
    if layout_name == '2_08':
        ...
        #if volume02 != 1:
        black_video02 = ColorClip(size=(603, 1070), color=(0, 0, 0), duration=(clip_duration))
        black_video02 = mp.video.fx.Margin(5, color=(255, 255, 0)).add_margin(black_video02)
        ...
        black_video_wave01 = ColorClip(size=(696, 355), color=(0, 0, 0), duration=clip_duration)
        black_video_wave01 = mp.video.fx.Margin(top=5, right=5, color=(255, 255, 0)).add_margin(black_video_wave01)
        ...
        black_video_wave02 = ColorClip(size=(696, 355), color=(0, 0, 0), duration=clip_duration)
        black_video_wave02 = mp.video.fx.Margin(top=5, right=5, color=(255, 255, 0)).add_margin(black_video_wave02)
        ...
        # 5 + 355 + 5 + 355 + 5 + 350 + 5
        final_clip = CompositeVideoClip([new_clip1.with_position((0, 0)), new_clip2.with_position((607, 0)),
    ...
    if layout_name == '3_01':
        ...
        total_duration01 = (clip1.duration * 1000) + delay01  # millisecond
        total_duration02 = (clip2.duration * 1000) + delay02  # millisecond
        total_duration03 = (clip3.duration * 1000) + delay02  # millisecond

        clip_duration = max((total_duration01 / 1000.0),(total_duration02 / 1000.0),(total_duration03 / 1000.0) )

        new_clip1 = clip1.with_effects([mp.video.fx.Resize((1910, 1070))])
        new_clip1 = mp.video.fx.Margin(5, color=(255, 255, 0)).add_margin(new_clip1)

        black_video01 = ColorClip(size=(1910, 1070), color=(0, 0, 0), duration=(clip_duration))
        black_video01 = mp.video.fx.Margin(5, color=(255, 255, 0)).add_margin(black_video01)
        ...
        black_video02 = ColorClip(size=(630, 350), color=(0, 0, 0), duration=(clip_duration))
        black_video02 = mp.video.fx.Margin(5, color=(255, 255, 0)).add_margin(black_video02)
        ...
        new_clip3 = clip3.with_effects([mp.video.fx.Resize((630, 350))])
        new_clip3 = mp.video.fx.Margin(5, color=(255, 255, 0)).add_margin(new_clip3)

        black_video03 = ColorClip(size=(630, 350), color=(0, 0, 0), duration=(clip_duration))
        black_video03 = mp.video.fx.Margin(5, color=(255, 255, 0)).add_margin(black_video03)
        ...
        new_clip3 = CompositeVideoClip([black_video03.with_position((0, 0)),
                                       ...
                                       size=(640, 360))
        new_clip3 = mp.video.fx.FadeIn(2).apply(new_clip3)
        new_clip3 = mp.video.fx.FadeOut(2).apply(new_clip3)

        new_clip3 = new_clip3.with_volume_scaled(volume03)

        final_clip = CompositeVideoClip([
            new_clip1.with_position((0, 0)),
            new_clip2.with_position((75, 245)),
            new_clip3.with_position((75, 665))],
            size=(1920, 1080))
    ...
    if layout_name == '3_02':
        ...
        final_clip = CompositeVideoClip([
            new_clip1.with_position((0, 0)),
            new_clip2.with_position((75, 645)),
            new_clip3.with_position((775, 645))],
            size=(1920, 1080))
    ...
    if layout_name == '3_04':
        ...
        image_3_04_left_filename = app_images_location + '3_04_left.png'
        image_3_04_top_right_filename = app_images_location + '3_04_top_right.png'
        image_3_04_bottom_right_filename = app_images_location + '3_04_bottom_right.png'
        ...
        Image304Left = ImageClip(image_3_04_left_filename)
        Image304Left = Image304Left.with_start(0).with_duration(clip1.duration)
        Image304Left = Image304Left.with_effects([mp.video.fx.Resize((100, 65))]).with_position((20, 20))

        Image304TopRight = ImageClip(image_3_04_top_right_filename)
        Image304TopRight = Image304TopRight.with_start(0).with_duration(clip2.duration)
        Image304TopRight = Image304TopRight.with_effects([mp.video.fx.Resize((100, 65))]).with_position((20, 20))

        Image304BottomRight = ImageClip(image_3_04_bottom_right_filename)
        Image304BottomRight = Image304BottomRight.with_start(0).with_duration(clip3.duration)
        Image304BottomRight = Image304BottomRight.with_effects([mp.video.fx.Resize((100, 65))]).with_position((20, 20))

        new_clip1 = clip1.with_effects([mp.video.fx.Resize((601, 1070))])
        new_clip1 = mp.video.fx.Margin(5, color=(255, 255, 0)).add_margin(new_clip1)
        # print('clip1-02 length: ' + str(new_clip1.duration) + " seconds")

        black_video01 = ColorClip(size=(601, 1070), color=(0, 0, 0), duration=clip_duration)
        black_video01 = mp.video.fx.Margin(5,  color=(255, 255, 0)).add_margin(black_video01)
        ...
        # print('clip1-03 length: ' + str(new_clip1.duration) + " seconds")
        new_clip2 = clip2.with_effects([mp.video.fx.Resize((945, 532))])
        new_clip2 = mp.video.fx.Margin(top = 5, right = 5, bottom = 5, color=(255, 255, 0)).add_margin(new_clip2)

        black_video02 = ColorClip(size=(945, 532), color=(0, 0, 0), duration=clip_duration)
        black_video02 = mp.video.fx.Margin(top = 5, right = 5, bottom = 5, color=(255, 255, 0)).add_margin(black_video02)
        ...
        new_clip3 = clip3.with_effects([mp.video.fx.Resize((945, 533))])
        new_clip3 = mp.video.fx.Margin(right = 5, bottom = 5, color=(255, 255, 0)).add_margin(new_clip3)

        black_video03 = ColorClip(size=(945, 533), color=(0, 0, 0), duration=clip_duration)
        black_video03 = mp.video.fx.Margin(right =5, bottom = 5, color=(255, 255, 0)).add_margin(black_video03)
        ...
        wav01_clip3 = wav01_clip2.with_effects([mp.video.fx.Resize((354, 264))])
        wav01_clip4 = mp.video.fx.Margin(top = 5, bottom=5, right=5, color=(255, 255, 0)).add_margin(wav01_clip3)

        wav01_clip4 = CompositeVideoClip([wav01_clip4, Image304Left])

        black_video_wave01 = ColorClip(size=(354, 264), color=(0, 0, 0), duration=clip_duration)
        black_video_wave01 = mp.video.fx.Margin(top = 5, bottom=5, right=5, color=(255, 255, 0)).add_margin(black_video_wave01)
        ...
        wav02_clip = VideoFileClip(wave02, fps_source='fps')
        wav02_clip2 = wav02_clip.with_volume_scaled(0.0)
        wav02_clip3 = wav02_clip2.with_effects([mp.video.fx.Resize((354, 264))])
        wav02_clip4 = mp.video.fx.Margin(bottom=5, right=5, color=(255, 255, 0)).add_margin(wav02_clip3)

        wav02_clip4 = CompositeVideoClip([wav02_clip4, Image304TopRight])

        black_video_wave02 = ColorClip(size=(354, 264), color=(0, 0, 0), duration=clip_duration)
        black_video_wave02 = mp.video.fx.Margin(bottom=5, right=5, color=(255, 255, 0)).add_margin(black_video_wave02)
        ...
        wav03_clip = VideoFileClip(wave03, fps_source='fps')
        wav03_clip2 = wav03_clip.with_volume_scaled(0.0)
        wav03_clip3 = wav03_clip2.with_effects([mp.video.fx.Resize((354, 264))])
        wav03_clip4 = mp.video.fx.Margin(bottom=5, right=5, color=(255, 255, 0)).add_margin(wav03_clip3)

        wav03_clip4 = CompositeVideoClip([wav03_clip4, Image304BottomRight])

        black_video_wave03 = ColorClip(size=(354, 264), color=(0, 0, 0), duration=clip_duration)
        black_video_wave03 = mp.video.fx.Margin(bottom=5, right=5, color=(255, 255, 0)).add_margin(black_video_wave03)
        ...
        final_wav_clip = VideoFileClip(wave_file, fps_source='fps')
        final_wav_clip2 = final_wav_clip.with_volume_scaled(0.0)
        final_wav_clip3 = final_wav_clip2.with_effects([mp.video.fx.Resize((354, 263))])
        final_wav_clip4 = mp.video.fx.Margin(bottom=5, right=5, color=(255, 255, 0)).add_margin(final_wav_clip3)

        final_clip = CompositeVideoClip([
            # new_clip1.with_position((0, 0)),
            wav01_clip4.with_position((1561, 0)),
            wav02_clip4.with_position((1561 , 274)),
            wav03_clip4.with_position((1561, 543)),
            final_wav_clip4.with_position((1561, 812)),

            new_clip1.with_position((0, 0)),
            new_clip2.with_position((611, 0)),
            new_clip3.with_position((611, 542))
    ...
    if layout_name == '3_05':
        ...
        # print('clip1-03 length: ' + str(new_clip1.duration) + " seconds")
        new_clip2 = clip2.with_effects([mp.video.fx.Resize((400, 710))])
        new_clip2 = mp.video.fx.Margin(5, color=(255, 255, 0)).add_margin(new_clip2)

        black_video02 = ColorClip(size=(400, 710), color=(0, 0, 0), duration=clip_duration)
        black_video02 = mp.video.fx.Margin(5, color=(255, 255, 0)).add_margin(black_video02)
        ...
        final_clip = CompositeVideoClip([
            new_clip1.with_position((0, 0)),
            new_clip2.with_position((60, 300)),
            new_clip3.with_position((1220, 660))
    ...
    if layout_name == '3_06':
        ...
        new_clip3 = clip3.with_effects([mp.video.fx.Resize((400, 710))])
        new_clip3 = mp.video.fx.Margin(5, color=(255, 255, 0)).add_margin(new_clip3)

        black_video03 = ColorClip(size=(400, 710), color=(0, 0, 0), duration=clip_duration)
        black_video03 = mp.video.fx.Margin(5, color=(255, 255, 0)).add_margin(black_video03)
        ...
        final_clip = CompositeVideoClip([
            new_clip1.with_position((0, 0)),
            new_clip2.with_position((60, 300)),
            new_clip3.with_position((1450, 300))
    ...
    if layout_name == '3_07':
        ...
        new_clip1 = clip1.with_effects([mp.video.fx.Resize((600, 1070))])
        new_clip1 = mp.video.fx.Margin(5, color=(255, 255, 0)).add_margin(new_clip1)
        # print('clip1-02 length: ' + str(new_clip1.duration) + " seconds")

        black_video01 = ColorClip(size=(600, 1070), color=(0, 0, 0), duration=clip_duration)
        black_video01 = mp.video.fx.Margin(5, color=(255, 255, 0)).add_margin(black_video01)
        ...
        # print('clip1-03 length: ' + str(new_clip1.duration) + " seconds")
        new_clip2 = clip2.with_effects([mp.video.fx.Resize((600, 1070))])
        new_clip2 = mp.video.fx.Margin(top = 5, right = 5, bottom = 5, color=(255, 255, 0)).add_margin(new_clip2)

        black_video02 = ColorClip(size=(600, 1070), color=(0, 0, 0), duration=clip_duration)
        black_video02 = mp.video.fx.Margin(top = 5, right = 5, bottom = 5, color=(255, 255, 0)).add_margin(black_video02)
        ...
        new_clip3 = clip3.with_effects([mp.video.fx.Resize((600, 1070))])
        new_clip3 = mp.video.fx.Margin(top = 5, right = 5, bottom = 5,  color=(255, 255, 0)).add_margin(new_clip3)

        black_video03 = ColorClip(size=(600, 1070), color=(0, 0, 0), duration=clip_duration)
        black_video03 = mp.video.fx.Margin(top = 5, right = 5, bottom = 5,  color=(255, 255, 0)).add_margin(black_video03)
        ...
        background = ColorClip(size=(1920, 1080), color=(0, 0, 0),  duration=clip_duration)

        final_clip = CompositeVideoClip([
            background.with_position((0, 0)),

            new_clip1.with_position((50, 0)),
            new_clip2.with_position((660, 0)),
            new_clip3.with_position((1265, 0))
    ...
    if layout_name == '4_01':
        ...
        total_duration02 = (clip2.duration * 1000) + delay02  # millisecond
        total_duration03 = (clip3.duration * 1000) + delay03  # millisecond
        total_duration04 = (clip4.duration * 1000) + delay04  # millisecond

        clip_duration = max(total_duration01, total_duration02, total_duration03, total_duration04) / 1000.0
        ...
        new_clip4 = clip4.with_effects([mp.video.fx.Resize((955, 530))])
        new_clip4 = mp.video.fx.Margin(right=5, bottom=5, color=(255, 255, 0)).add_margin(new_clip4)

        black_video04 = ColorClip(size=(955, 530), color=(0, 0, 0), duration=clip_duration)
        black_video04 = mp.video.fx.Margin(right=5, bottom=5, color=(255, 255, 0)).add_margin(black_video04)

        new_clip4 = mp.video.fx.CrossFadeIn(2).apply(new_clip4)
        new_clip4 = mp.video.fx.CrossFadeOut(2).apply(new_clip4)
        new_clip4 = CompositeVideoClip([black_video04.with_position((0, 0)),
                                        new_clip4.with_position((0, 0)).with_start(milli_to_timecode(delay04))],
                                       size=(960, 535))
        ...
        final_clip = CompositeVideoClip([
            ...
            new_clip2.with_position((960, 0)),
            new_clip3.with_position((0, 545)),
            new_clip4.with_position((960, 545))
...
if __name__ == '__main__':
    ...
    #merge_full('2_01', app_media_location + 'Jazz-02-Drum.mp4', app_media_location +  'Jazz-03-Saxophone.mp4','','',
    #           0, 2168, 0,0 ,
    #           1.0, 1.0,1.0,1.0,
    #           'omiejung')

    #merge_full('2_02', app_media_location +  'Jazz-03-Saxophone.mp4', app_media_location + 'Jazz-02-Drum.mp4','','',
    #           2168, 0,0,0,
    #           1.0, 1.0,1.0,1.0,
    #           'omiejung')

    #merge_full('2_03', app_media_location + 'Jazz-02-Drum.mp4', app_media_location +  'Jazz-03-Saxophone.mp4','','',
    #           0, 2168, 0,0 ,
    #           1.0, 1.0,1.0,1.0,
    #           'omiejung')
    ...
    #merge_full('3_04', app_media_location + 'Jazz-02-Drum-P.mp4', app_media_location + 'Jazz-04-DoubleBass.mp4',
    #           app_media_location + 'Jazz-03-Saxophone.mp4', '',
    #           0, 2168, 2168, 0,
    #           1.0, 1.0, 1.0, 1.0, 'omiejung')

    #merge_full('3_05', app_media_location + 'Jazz-04-DoubleBass.mp4',app_media_location + 'Jazz-02-Drum-P.mp4',
    #           app_media_location + 'Jazz-03-Saxophone.mp4', '',
    #           2168, 0, 2168, 0,
    #           1.0, 1.0, 1.0, 1.0, 'omiejung')

    #merge_full('3_06', app_media_location + 'Jazz-04-DoubleBass.mp4',app_media_location + 'Jazz-02-Drum-P.mp4',
    #           app_media_location + 'Jazz-03-Saxophone-P.mp4', '',
    #           2168, 0, 2168, 0,
    #           1.0, 1.0, 1.0, 1.0, 'omiejung')

    #merge_full('3_07', app_media_location + 'Jazz-04-DoubleBass-P.mp4', app_media_location + 'Jazz-02-Drum-P.mp4',
    #           app_media_location + 'Jazz-03-Saxophone-P.mp4', '',
    #           2168, 0, 2168, 0,
    #           1.0, 1.0, 1.0, 1.0, 'omiejung')


    merge_full('4_01', app_media_location + 'Jazz-04-DoubleBass.mp4',
               app_media_location + 'Jazz-02-Drum.mp4',
               app_media_location + 'Jazz-03-Saxophone.mp4',
               app_media_location + 'Jazz-01-Piano.mp4',
                2168, 0, 2168, 820,
                1.0, 1.0, 1.0, 1.0,'omiejung')
