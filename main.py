...
if __name__ == '__main__':
    ...
    merge_full('2_03', 'C:\\media\\mp4\\Jazz-02-Drum.mp4', 'C:\\media\\mp4\\Jazz-03-Saxophone.mp4',
               0, 2168,
               1.0, 1.0,
               'omiejung')
    #merge_full('2_03', 'C:\\media\\mp4\\Jazz-03-Saxophone.mp4', 'C:\\media\\mp4\\Jazz-02-Drum.mp4',
    #           2168, 0,
    #           1.0, 1.0,
    #           'omiejung')
