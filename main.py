...
def merge_full(layout_name, video01_filename, video02_filename, delay01, delay02, volume01, volume02, owner_name):
    ...
    if layout_name == '2_01':
        ...
        new_clip1 = mp.video.fx.Margin(left=5,top=5,bottom=5, right = 5, color=(255, 255, 0)).add_margin(new_clip1)
        ...
        final_clip = CompositeVideoClip([new_clip1.with_position((0,0)), new_clip2.with_position((608, 0)), wav_clip4.with_position((608,738))],
                                        size=(1920, 1080))
